...
import api.parkingcontrol.dtos.ParkingSpotDto;
import api.parkingcontrol.models.ParkingSpotModel;
import api.parkingcontrol.services.ParkingSpotService;
...
public class ParkingSpotController {
    ...
    //Usuários têm acesso somente ao GET e GET ALL.
    //Admins podem acessar todos os GET, incluindo também POST, PUT e DELETE.
    ...
    public ResponseEntity<Object> deleteParkingSpot(@PathVariable(value="id") UUID id){
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Parking spot removed!");
    }
